...
def SetGame(): # this function will make display changes acc to GameState
    global TankA,TankB,dmg,hit,p1,p2,hp1,hp2,a1,a2,a3,a4,messagebox,canvas2x,hb1,hb2,HT,canvas73,l1,l2,player_shield
...
class Tank:
    ...
    def shield(self):
        ...
        if self==w1:
            player_shield=canvas73.create_polygon([55,150,55,160,80,160,80,200,90,200,90,150,55,150],fill=self.colour)
        else:
            x = int(canvas73['width'])
            player_shield=canvas73.create_polygon([x-55,150,x-55,160,x-80,160,x-80,200,x-90,200,x-90,150,x-55,150],fill=self.colour)
