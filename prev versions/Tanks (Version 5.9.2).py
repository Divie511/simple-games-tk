...
class Tank:
    ...
    def shield(self):
        if self==w1:
            self.shield=canvas73.create_polygon([100,125,120,125,150,150,120,170,150,200,120,225,100,225,100,125],fill=self.colourx)
            canvas73.after(1000,self.delete_shield)   
        else:
            self.shield=canvas73.create_polygon([300,125,280,125,250,150,280,170,250,200,280,225,300,225,300,215],fill=self.coloury)
            canvas73.after(1000,self.delete_shield)
