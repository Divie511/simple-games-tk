...
try:
    ...
    print("ERROR: playerdata.py not found!\nYou can download the file from github.com/iamgroot9/iamgroot")
    print("Make sure you copy it to the same folder as TANKS")
    quit()
...
def Login2p(*args):
    ...
    elif passcheck: selectColour2p(u1,u2)
...
def intro2p():
    ...
    login_message.pack()
    f3.pack()
    game_window.bind('<Return>',Login2p) # press enter to login
    Button(f3, text = 'Login', bg = '#000', fg = '#10ff00', command = Login2p, cursor = 'hand2').pack()
